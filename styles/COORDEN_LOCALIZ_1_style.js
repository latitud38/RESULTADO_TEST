...
var style_COORDEN_LOCALIZ_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 9.6 + size, points: 6,
        ...
        image: new ol.style.RegularShape({radius: 3.92728 + size, points: 6,
